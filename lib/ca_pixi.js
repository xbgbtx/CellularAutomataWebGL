class CAPixi
{
    constructor ( width, height )
    {
        ...
        canvas_div.appendChild ( this.pixi_app.view );
    ...
    create_pixi_app ( canvas_div ) 
    {
        ...
        this.pixi_app = new PIXI.Application ( { resizeTo: canvas_div });
    ...
    create_display_sprite ( width, height )
    {
        ...
        this.display_sprite
            ...
            .on ( 'pointermove', ( e ) => 
            {
                let x = e.data.global.x - this.display_sprite.x;
                let y = e.data.global.y - this.display_sprite.y;
                if ( this.drawing )
                {
                    canvas_mouse ( x, y );
                }
    ...
    {
        let w = this.pixi_app.renderer.width;
        let h = this.pixi_app.renderer.height;
        this.display_sprite.x = (w/2)-this.display_sprite.width/2;
        this.display_sprite.y = (h/2)-this.display_sprite.height/2;
    }
