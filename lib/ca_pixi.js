class CAPixi
{
    ...
    {
        let width = this.sim_size.width;
        let height = this.sim_size.height;
        let resolution = 1;
    ...
    resize_sim ( width, height )
    {
        ...
        this.set_automaton ( this.automaton );
        this.center_display_sprite ();
    }
    ...
    set_automaton ( a )
    {
        ...
        let uniforms = 
        {
            width: this.sim_size.width,
            height: this.sim_size.height
        };
